...
t3lib_extMgm::addStaticFile($_EXTKEY,'static/lonewsadresses_must_have/', 'LONewsAdresses must have');

t3lib_extMgm::addStaticFile($_EXTKEY,'static/lonewsadresses_standarddesign/', 'LONewsAdresses Standarddesign');
...
t3lib_extMgm::addStaticFile($_EXTKEY,"pi1/static/","LONewsAdresses Google Map");
